...
migrate((app) => {
  ...
  unmarshal({
    "viewQuery": "SELECT dss.id, specialtyService FROM contractors_services as cs\nJOIN dict_specialty_services as dss ON dss.id = cs.id;"
  }, collection)

  // remove field
  collection.fields.removeById("_clone_gq5J")
  ...
  // remove field
  collection.fields.removeById("_clone_Uq4U")
