...
migrate((app) => {
  ...
  unmarshal({
    "indexes": [
      "CREATE UNIQUE INDEX `idx_tokenKey_pbc_1454814972` ON `deprecated_contractor` (`tokenKey`)",
      "CREATE UNIQUE INDEX `idx_email_pbc_1454814972` ON `deprecated_contractor` (`email`) WHERE `email` != ''",
      "CREATE UNIQUE INDEX `idx_4UpFXxTcxS` ON `deprecated_contractor` (`hrid`)"
    ],
    "name": "deprecated_contractor"
  }, collection)
